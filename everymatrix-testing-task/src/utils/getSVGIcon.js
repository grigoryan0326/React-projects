export default function getIcon(name, w = 18, h = 18) {
  switch (name) {
    case "mail":
      return (
        <svg
    ...
    case "download":
      return (
        <svg
          ...
          xmlns='http://www.w3.org/2000/svg'
        >
          <g clipPath='url(#clip0_1415_185)'>
            <path
              d='M5.83342 27.7083H29.1668V17.5H32.0834V29.1667C32.0834 29.5534 31.9298 29.9244 31.6563 30.1979C31.3828 30.4714 31.0119 30.625 30.6251 30.625H4.37508C3.98831 30.625 3.61737 30.4714 3.34388 30.1979C3.07039 29.9244 2.91675 29.5534 2.91675 29.1667V17.5H5.83342V27.7083ZM20.4167 13.125H27.7084L17.5001 23.3333L7.29175 13.125H14.5834V4.375H20.4167V13.125Z'
              fill='white'
            />
          </g>
          <defs>
            <clipPath id='clip0_1415_185'>
              <rect
                width='35'
                height='35'
                fill='white'
    ...
    case "like":
      return (
        ...
        >
          <path
            d='M2.91671 13.125H7.29171V30.625H2.91671C2.52993 30.625 2.159 30.4714 1.88551 30.1979C1.61202 29.9244 1.45837 29.5535 1.45837 29.1667V14.5834C1.45837 14.1966 1.61202 13.8257 1.88551 13.5522C2.159 13.2787 2.52993 13.125 2.91671 13.125ZM10.6357 11.2394L19.969 1.90608C20.093 1.78168 20.2578 1.70624 20.4331 1.69365C20.6083 1.68106 20.7822 1.73215 20.9228 1.83754L22.1667 2.77087C22.5122 3.03023 22.7731 3.38608 22.9167 3.79354C23.0602 4.201 23.0798 4.64184 22.9732 5.06046L21.2917 11.6667H30.625C31.3986 11.6667 32.1405 11.974 32.6874 12.521C33.2344 13.068 33.5417 13.8098 33.5417 14.5834V17.6517C33.5421 18.0329 33.4678 18.4104 33.323 18.763L28.8094 29.7223C28.6993 29.9895 28.5123 30.218 28.2721 30.3787C28.032 30.5394 27.7494 30.6252 27.4605 30.625H11.6667C11.2799 30.625 10.909 30.4714 10.6355 30.1979C10.362 29.9244 10.2084 29.5535 10.2084 29.1667V12.2705C10.2085 11.8837 10.3622 11.5128 10.6357 11.2394Z'
            fill='white'
          />
        </svg>
      )
    ...
    case "star":
      return (
        <svg
          ...
          xmlns='http://www.w3.org/2000/svg'
        >
          <g clipPath='url(#clip0_1415_142)'>
            <path
              d='M17.5 26.6291L7.21441 32.3866L9.51129 20.825L0.856079 12.8216L12.5621 11.4333L17.5 0.729126L22.438 11.4333L34.144 12.8216L25.4888 20.825L27.7857 32.3866L17.5 26.6291Z'
              fill='white'
            />
          </g>
          <defs>
            <clipPath id='clip0_1415_142'>
              <rect
                width='35'
                height='35'
                fill='white'
